...
export default class CardView extends Component {
  ...
  static defaultProps = {
    ...
    scale: 1,
    fontFamily: Platform.select({ ios: "Courier", android: "Mulish_Regular" }),
  };
    ...
    return (
      <View style={[s.cardContainer, containerSize]}>
        <FlipCard style={{ borderWidth: 0 }}
          ...
          flip={shouldFlip}>
          <View
            style={[BASE_SIZE, s.cardFace, transform, { backgroundColor: Colors.primaryColor, borderRadius: 20.0, }]}
          >
            <Image style={[s.icon]}
              source={Icons[brand]} />
          ...
          <View style={[BASE_SIZE, s.cardFace, transform, { backgroundColor: Colors.primaryColor, borderRadius: 20.0, }]}>
